...
int main()
{
   ...
   char *path = "/Users/kidwelldlamini/Documents/Operating Systems/test_data/"; // Change this to the directory where the input and output files are located
   ...
   for(x=0;x<1000;x++)
   {
      sprintf(infilename,"%sin%d.txt", path, x+1);
      sprintf(outfilename,"%sout%d.txt", path, x+1);
